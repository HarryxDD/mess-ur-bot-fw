...
int MPU9250::begin(){
  ...
  // check the WHO AM I byte, expected value is 0x71 (113), 0x73 (115), or 0x70 (112 for MPU6500)
  ...
  if(writeRegister(USER_CTRL,I2C_MST_EN) < 0){
	...
	if( whoAmIAK8963() != 72 ){
    // Not an MPU9250 (probably MPU6500 missing the AK8963 compass)
    // Return early with success, since Accel and Gyro are already initialized.
    return 1;
	}
